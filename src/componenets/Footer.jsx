...
function Footer() {
  return (
    <section className="w-[1282px] ml-[150px] relative overflow-hidden bg-[#130F0C] font-poppins">
      <div className="w-[1282px] h-[401px]">
        <div className="absolute">
          <div className="mt-56 w-[575px] h-[57px] top-[1091px] left-[795px]">
            <h2 className="relative bottom-[87px] left-16 text-white text-[38px] font-[400] items-center border-b-4 border-white">
          ...
          <div className="w-full ml-16 -mt-14">
            <div className="w-full flex gap-10 z-50">
              <div className="border-2 bg-white bg-opacity-10">
                <input
                  className="flex h-10 w-[516px] h-[40px] border-4 border-white bg-transparent px-3 py-2 text-sm placeholder:text-gray-100 
              ...
              <button
                className="w-3/6 text-[14px] px-2 bg-[#D29A5A] text-white rounded-sm"
                type="submit"
              >
                SUBSCRIBE
              </button>
        ...
        <img className="w-full" src={subscribeImg} alt="footer image" />
      </div>

      <div className="w-full h-[75px] container">
        <div className="border-b-8 border-[#D29A5A]">
          <div className="flex justify-between px-10 items-center mt-16 mb-10 ml-10">
            <div className="w-[371px] h-[73px]">
              <h2 className="text-[#D29A5A] text-[24px] flex gap-5">
                <img className="w-[36px] h-[32px]" src={Vector} alt="" />
                FREE SHIPPING WORLDWIDE
              </h2>
              <h3 className="text-white text-[18px] ml-14 mt-3">
                Guaranteed Delivery
              </h3>
            </div>
            <div className="w-[371px] h-[73px]">
        ...
        {/* <img
          className="w-full border-b-8 border-[#D29A5A]"
          src={subscribeImg}
          alt="footer image"
        /> */}
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          ...
          {/* <div className="w-[1282px] h-[8px]"></div> */}
          <div className="">
            <div className="top-[2743px] left-[575px]">
              <img className="w-[447px] h-[299px]" src={logo} alt="logo" />
            </div>
          </div>
          <div className="w-auto p-8">
