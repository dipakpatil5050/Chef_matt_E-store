...
function Footer() {
  return (
    <section className="relative overflow-hidden bg-[#130F0C] py-8 font-poppins">
      <div>
        <img src={subscribeImg} alt="footer image" />
      </div>
      <div className="container relative z-10 mx-auto px-4">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto p-8 text-[#D29A5A]">
